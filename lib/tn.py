...
# Coder     : Nexamos (19 years guy from Tunisia)
# our team page       : https://web.facebook.com/Kalachnikov.Tn/  
# Twitter   : @nexamos
...
#              greats also to tunisia fallega team Greetz to Kalachnikov Team  & to madleets team and to you !
...
class TNscan :
 ...
 this a developed version of al-swisre code (well i think it's even better) anyway greats to that man
 Greats to : all Muslim (ethical and unethical) Hackers who are fighting for an issue
         greats also to tunisian fallega team, and Greetz to Kalachnikov team &  to madleets team and to you !
 Wroten with <3 in my arch machine using geany, a cup of tea and while listening to jazz 
"""
